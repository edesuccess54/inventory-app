...
const ItemCard:React.FC<ItemCardProps> = ({heading, color, title, total, amount, period, last}) => {
  return (
    <>
        <div className='flex-1'>
            <h2 style={{color}} className='font-semibold text-base'>{heading}</h2>
        ...
        {!last && (
            <div className='border border-[#F0F1F3]'></div>
        )}    
    </>
  )
}
