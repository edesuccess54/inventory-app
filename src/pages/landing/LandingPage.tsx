...
export default function InventoryLanding() {
  ...
  return (
    <div className="min-h-screen bg-white text-text-default overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <p className="text-xl md:text-2xl text-gray-600 mb-8 leading-relaxed animate-slideInUp">
              Track products, manage suppliers, and gain insights with our comprehensive inventory
              management system.
            </p>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            {stats.map((stat, index) => (
              ...
              >
                <div
                  className={`text-4xl md:text-5xl font-bold bg-gradient-to-r ${stat.color} bg-clip-text text-transparent mb-2 group-hover:animate-pulse`}
                >
                  {stat.value}
                </div>
      ...
      <section
        id="pricing"
        className="py-20 px-4 bg-gradient-to-b from-white to-blue-50 relative z-10"
      >
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold mb-4 text-gray-900">
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            {plans.map((plan, index) => (
              ...
              >
                ...
                <button
                  className={`w-full py-3 rounded-lg font-semibold mb-6 transition-all transform hover:scale-105 hover:shadow-lg ${
                    plan.popular
                ...
                <ul className="space-y-3">
                  {plan.features.map((feature, idx) => (
                    <li
                      key={idx}
                      className="flex items-start space-x-3 transform hover:translate-x-2 transition-transform"
                    >
                      <Check
                        className={`w-5 h-5 flex-shrink-0 mt-0.5 ${plan.popular ? "text-blue-200" : "text-green-600"}`}
                      />
            ...
            <div className="space-y-6">
              <div>
                ...
                <p className="text-gray-600 mb-8">
                  Feel free to reach out through any of these channels. Our team is ready to assist
                  you.
                </p>
              </div>
